...
//imagen del primer personaje
 image(pj1,ipjX,height/5.5,234,308);
...
if (timertexto < 120) {
 ...
 text("zero_one es el primero de los cinco tombsonas principales en la versión ficticia de la banda The Living Tombstone. Es el compositor, productor musical y vocalista de la banda. Actúa como líder del resto de los miembros. Zero_one es muy optimista, y parece que disfri", 350, height/7, 250, 350);
 timertexto++;
