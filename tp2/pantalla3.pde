...
//imagen del segundo personaje
 image(pj2,ipjX,height/5.5,234,308);
...
if (timertexto < 120) {
 ...
 text("Rust es el segundo de los cinco personajes principales de la versión ficticia de la banda The Living Tombstone. Es el vocalista principal de la banda. Rust es muy rebelde, resistente y desafiante a la autoridad. Entre todos los tombsonas es el que más siente la emoción humana pura y la empatía.", 350, height/7, 250, 350);
 timertexto++;
