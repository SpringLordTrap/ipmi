...
//imagen del cuarto personaje
 image(pj4,ipjX,height/5.5,234,308);
...
if (timertexto < 120) {
 ...
 text("Tesla es el cuarto de los cinco personajes principales de la versión ficticia de la banda The Living Tombstone. Es el bajista de la banda. Tesla es enérgico, arrogante y tiene una alta opinión de sí mismo, es el más inteligente y rápido de todos los tombsonas.", 350, height/7, 250, 350);
 timertexto++;
