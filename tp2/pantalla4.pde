...
//imagen del tercer personaje
 image(pj3,ipjX,height/5.5,234,308);
...
if (timertexto < 120) {
 ...
 text("Armstrong es el tercero de los cinco personajes principales de la versión ficticia de la banda The Living Tombstone. Es el guitarrista de la banda. Armstrong se inspira en la Era Atómica y la Era Espacial de la década de 1950. Recibe su nombre del famoso astronauta Neil Armstrong.", 350, height/7, 250, 350);
 timertexto++;
